...
const reports = [
  ...
  },
  {
    ...
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua',
    href: 'stock-in-report',
    icon: BookmarkAltIcon,
  },
  {
    name: 'Stock out report',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua',
    href: 'stock-out-report',
    icon: CalendarIcon,
  },
  { 
    name: 'Purchase request report',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua',
    href: 'purchase-request-report',
            ...
            <Popover className="relative">
              {({ open }) => (
                <>
                  ...
                  >
                    <span className='mr-1'>Hi {authService.currentUser?.name || 'user'}!</span>
                    <img
                      className="inline-block h-12 w-12 rounded-full ring-2 ring-white"
                      src="https://react-inv-api-api-dev-images.s3.ap-southeast-1.amazonaws.com/avatar.png"
                      alt=""
                    />
                  </Popover.Button>
                    ...
                    <Popover.Panel className="absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 max-w-md sm:px-0">
                      <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                        <div className="relative grid gap-6 bg-white px-1 py-6 sm:gap-8 sm:p-8">
                          <a className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50 text-sm cursor-pointer" onClick={handleLogout}>
                          Logout</a>
                        </div>
                      </div>
                    </Popover.Panel>
