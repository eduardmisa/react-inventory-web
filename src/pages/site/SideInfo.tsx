                                    ...
                                    <div className="absolute inset-0 px-4 sm:px-6">
                                        <div className="h-full" aria-hidden="true">
                                            <div className="mb-3 xl:w-96">
                                                ...
                                                {stagedComponent && <>
                                                    <div className="p-3 mb-5 border border-dotted">
                                                        <span className="text-sm mb-3">Staged component : </span> {stagedComponent?.name}
                                                        <br/>
                                                        <pre className="text-xs text-gray-500">{JSON.stringify(stagedComponent, null, 2)}</pre>
                                                    </div>
                                                </>}
