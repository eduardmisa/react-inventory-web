...
import { IVendorListResponse, IVendorInfo } from "../../_api/VendorApi";
...
function Vendor() {
  ...
  const [listData, setListData] = useState<IVendorListResponse>();
    ...
    <>
      ...
      <div className="flex flex-col max-w-7xl mx-auto px-4 sm:px-6">
        <div className="content-center mb-5">
          <span className="text-5xl text-indigo-100 font-bold">Vendors | </span>
...
export default AuthorizedLayout(Vendor)
