...
import { ILocationListResponse, ILocationInfo } from "../../_api/LocationApi";
...
function Location() {
  ...
  const [listData, setListData] = useState<ILocationListResponse>();
    ...
    <>
      ...
      <div className="flex flex-col max-w-7xl mx-auto px-4 sm:px-6">
        <div className="content-center mb-5">
          <span className="text-5xl text-indigo-100 font-bold">Locations | </span>
...
export default AuthorizedLayout(Location)
